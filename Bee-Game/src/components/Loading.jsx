    ...
    <div className="bg-black relative h-screen w-full">
      ...
      <div className="p-5">
        ...
        <button onClick={toggle}
          className="overflow-hidden absolute mt-[-20px] md:mt-8 w-32 p-2 h-12 bg-neutral-900 text-white border-none rounded-md text-xl font-bold cursor-pointer bottom-[9%] md:bottom-[3%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 group"
        >
          Play
